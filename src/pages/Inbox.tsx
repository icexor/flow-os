...
import {
  ...
  Sparkles, CheckCircle, X, Edit, ChevronRight,
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1 mt-1.5">
                      ...
                      <span className="text-[10px] text-muted-foreground">AI {item.confidence}%</span>
            ...
            <div className="p-5 border-b border-border/60">
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <h3 className="text-base font-semibold text-foreground">{selectedItem.subject}</h3>
                  <div className="flex items-center gap-3 mt-1 text-xs text-muted-foreground">
                    <span className="flex items-center gap-1"><User className="w-3 h-3" />{selectedItem.sender} · {selectedItem.senderCompany}</span>
                    <span className="flex items-center gap-1"><FolderKanban className="w-3 h-3" />{selectedItem.project}</span>
